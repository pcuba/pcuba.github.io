...
Link to [local copy](/documents/Draft_EFStag_CS.pdf). This version: April 2020 (This paper replaces the version circulated with the title [“Understanding Persistent Stagnation”](/documents/Draft_EFStag_CS_old.pdf)).<br>
{: .notice}
