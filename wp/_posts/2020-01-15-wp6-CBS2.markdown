...
Link to [local copy](/documents/Draft_EFStag_CS.pdf). This version: April 2020 (This paper replaces a previous version circulated with the title “Understanding Persistent Stagnation”).<br>
{: .notice}
